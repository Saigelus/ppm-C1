...
/*Suma matrices.
El programa, al recibir comod atos dos arreglos bidimensionales del mismo
tamaño, calcula la suma de ambos y la almacena en unt ercer arreglo
bidimensional.*/
...
/*Se verifica que el número d efilas sea correcto. */
do
{
    printf("Ingrese el lnúmero de columnas en los arreglos: ");
    scanf("%d", &COL);
} while (COL > MAX || COL < 1);
...
/*La función Impirime se utiliza paar escribir un arreglo bidiemnsiona de tipo entero de F filas y C columnas*/
{
int I, J; 
for (I=0; I<F; I++)
    for (J=0; J<C; J++)
