...
/*Observa que la función fread tiene los mismos argumentos que la función fwrite del programa anterior. También es importante tomar nota de que cuadno 
...
de ingreasr al ciclo y luego las siguientes dentro del ciclo, pero como última
