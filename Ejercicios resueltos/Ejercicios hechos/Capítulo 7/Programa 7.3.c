...
caractere de terminación '\0' a la posición de memoria a la que apunta la 
variable cad0 -apuntador del tipo cadena de caracteres. */

char cad1[20] = "Hola";     /*Se asignan cuatro caracteres más el caractere 
...
el carcter de terminación) a la variable cad2. Observa que cad2 no tiene espacio 
