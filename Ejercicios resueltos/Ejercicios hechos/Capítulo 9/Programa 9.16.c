...
/*Esta función lee cadenas de caracteres de una rchivo, detecta aquellas 
...
while (!feof (ap1))
{
    ...
    r = atof(cad);
    /*Recuerda que la función atof convierte una cadnea de caracteres que 
    contiene números reales a un valor de tipo double. Si la cadena comienza 
    con otro carctere o no contiene números, regresa p o el valor queda 
    indefinido. */
    if (r)
    {
        i++;
