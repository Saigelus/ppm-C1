...
inicializa cno un valor muy alto para que el primer valor ingresado 
...
void Acutem(float T)
/*Esta función acumula las temperaturas en al variable global ACT 
...
produjo en las variables gloaales MIN y HMIN.*/
{
if (MIN > T)
{
    MIN = T;
