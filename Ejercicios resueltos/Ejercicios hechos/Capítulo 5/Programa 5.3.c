...
cuatro posiciones y cae en una dirección afuera del arreglo. Esto ocasionará un 
error. . */
...
Y = *IX;             /*IX se mueve una posición y cae en una celda incorrecta. */
*IX = 15;            /*X toma el valor (basura) de la celda a la que apunta IX.*/
