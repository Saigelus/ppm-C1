...
/*La función Lectura se utiliza para ller un arreglo unidimensional de T
...
encuentra el elemento, la función regresa a la posición correspondiente. 
En caso contrario, regresa a 0. */
{
