...
/*Elección.
El programa almacena los votos emitidos en una elección en al que hubo cinco
...
while (VOT)
{
    if ((VOT > 0) && (VOT < 6))               /*Se verifica que el voto sea correcto.*/
        ...
        Recuerda que la primera posición del arreglo es 0, por esa razón 
        a la variable VOT se le decuenta 1. Los votos del primer candidato se
